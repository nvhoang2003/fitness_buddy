                    ...
                    <div class="col-lg-8 mb-4 mb-lg-0">
                            ...
                            <table class="table text-nowrap">
                                ...
                                <tr>
                                    <th class="ps-0 py-3 border-light" scope="row">
                                        <div class="d-flex align-items-center"><a class="reset-anchor d-block animsition-link" href=""><img src="/images/product/MD_AO_1_1.jpg" alt="..." width="70"/></a>
                                            <div class="ms-3"><strong class="h6"><a class="reset-anchor animsition-link" href="">Red digital smartwatch</a></strong></div>
                                        </div>
                                    </th>
                                ...
                                <tr>
                                    <th class="ps-0 py-3 border-0" scope="row">
                                        <div class="d-flex align-items-center"><a class="reset-anchor d-block animsition-link" href="#"><img src="/images/product/MD_AO_4_1.jpg" alt="..." width="70"/></a>
                                            <div class="ms-3"><strong class="h6"><a class="reset-anchor animsition-link" href="#">Apple watch</a></strong></div>
                                        </div>
                                    </th>
                                    ...
                                    <td class="p-3 align-middle border-0"><a class="reset-anchor" href="#!">
                        ...
                        <div class="bg-light px-4 py-3">
                            <div class="row align-items-center text-center">
                                <div class="col-md-6 mb-3 mb-md-0 text-md-start"><a class="btn btn-link p-0 text-dark btn-sm" href="{{route("client.shop")}}">
                                        <i class="fas fa-long-arrow-alt-left me-2"> </i>Continue shopping</a></div>
                                <div class="col-md-6 text-md-end"><a class="btn btn-outline-dark btn-sm" href="{{route("client.checkout")}}">
                                        Procceed to checkout<i class="fas fa-long-arrow-alt-right ms-2"></i></a></div>
                            </div>
                        </div>
                    </div>
                    <!-- ORDER TOTAL-->
                            ...
                            <div class="card-body">
                                ...
                                <ul class="list-unstyled mb-0">
                                    <li class="d-flex align-items-center justify-content-between">
                                        ...
                                        <span class="text-muted small">$250</span></li>
                                        ...
                                        <form action="#">
                                            <div class="input-group mb-0">
                                                ...
                                                <button class="btn btn-dark btn-sm w-100" type="submit">
                                                    <i class="fas fa-gift me-2"></i>Apply coupon</button>
                                            </div>
                                        </form>
                                    </li>
                                </ul>
