                    ...
                    <div class="row align-items-stretch">
                        ...
                        <div class="col-lg-6">
                            <div class="p-4 my-md-4">
                                ...
                                <p class="text-sm mb-4">Lorem ipsum dolor sit amet,
                                    consectetur adipiscing elit. In ut ullamcorper leo,
                                ...
                                <div class="row align-items-stretch mb-4 gx-0">
                                    ...
                                    <div class="col-sm-5">
                                        <a class="btn btn-dark btn-sm w-100 h-100 d-flex align-items-center justify-content-center px-0"
                                            href={{route('client.cart')}}>Add to cart</a></div>
                                </div><a class="btn btn-link text-dark text-decoration-none p-0"
                                         href="#!"><i class="far fa-heart me-2">
    ...
    <div class="container">
        ...
        <section class="pt-5">
            <header class="text-center">
                ...
                <h2 class="h5 text-uppercase mb-4">Browse our style</h2>
            </header>
            <div class="row">
                @foreach($style as $st)
