...
@section('main')
    <div class="container col-md-8">
        ...
        <form action="{{route('customer.updateInfo',['username' => old('username') ?? $user->username])}}" method="post">
            @csrf
            ...
            <a type="button" href="{{route('customer.changePassword', ['username' => $user->username])}}"
               class="btn btn-info">
                Change Password
